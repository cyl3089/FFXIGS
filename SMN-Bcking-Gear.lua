function build_gearsets()
    ...
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: Attack+30 Pet: Rng.Atk.+30','Blood Pact Dmg.+10','Pet: Mag. Acc.+12',}},
...
--	waist="Regal Belt",
	...
	-- Fast Cast
	sets.precast.FC =  {  
--    main={ name="Grioavolr", augments={'Blood Pact Dmg.+9','Pet: INT+19','Pet: Mag. Acc.+15','Pet: "Mag.Atk.Bns."+24','DMG:+16',}},
    main="Oranyan",
    sub="Niobid Strap",
    ammo="Sancus Sachet +1",
    head={ name="Psycloth Tiara", augments={'Mag. Acc.+20','"Fast Cast"+10','INT+7',}},
    body="Zendik Robe",
    hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+16 "Mag.Atk.Bns."+16','"Fast Cast"+6',}},
    legs={ name="Psycloth Lappas", augments={'MP+80','Mag. Acc.+15','"Fast Cast"+7',}},
    feet={ name="Merlinic Crackows", augments={'"Fast Cast"+6',}},
    neck="Smn. Collar +2",
    waist="Embla Sash",
...
--	waist="Regal Belt",
    ...
    hands={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+28','Blood Pact Dmg.+10','Pet: DEX+7','Pet: Mag. Acc.+9',}},
    legs={ name="Enticer's Pants", augments={'MP+50','Pet: Accuracy+15 Pet: Rng. Acc.+15','Pet: Mag. Acc.+15','Pet: Damage taken -5%',}},
...
------------------------------------------------------------------	
    ...
    hands="Asteria Mitts +1",
    legs="Assid. Pants +1",
    feet={ name="Apogee Pumps +1", augments={'MP+60','Summoning magic skill +15','Blood Pact Dmg.+7',}},
--    feet="Convo. Pigaches +3",
    neck="Twilight Torque",
    waist="Fucho-no-Obi",
...
--    feet="Convo. Pigaches +3",
    ...
    left_ring="Varar Ring +1",
    right_ring="Varar Ring +1",
    back={ name="Conveyance Cape", augments={'Summoning magic skill +3','Pet: Enmity+13','Blood Pact Dmg.+3','Blood Pact ab. del. II -2',}},
}
